  ...
  forecastFetch = async () => {
    ...
    try {
      const query = axios.get(
        `https://api.openweathermap.org/data/2.5/forecast?lat=${this.props.latitude}&lon=${this.props.longitude}&units=metric&appid=${process.env.REACT_APP_KEY_OPEN_WEATHER_FORECAST}`
      );
